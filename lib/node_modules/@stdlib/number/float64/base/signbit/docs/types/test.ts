...
{
	signbit( 4.0 ); // $ExpectType boolean
	signbit( -9.14e-307 ); // $ExpectType boolean
...
{
	signbit( '5' ); // $ExpectError
	signbit( true ); // $ExpectError
	signbit( false ); // $ExpectError
	signbit( null ); // $ExpectError
	signbit( undefined ); // $ExpectError
	signbit( [] ); // $ExpectError
	signbit( {} ); // $ExpectError
