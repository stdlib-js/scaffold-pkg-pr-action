...
tape( 'the command-line interface prints the current year', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		fpath
	];
	...
	function done( error, stdout, stderr ) {
		...
		if ( error ) {
			...
			t.strictEqual( stdout.toString(), year+'\n', 'prints expected value to `stdout`' );
...
tape( 'the command-line interface supports use as a standard stream (mixed values)', opts, function test( t ) {
	var cmd = [
		'printf "beep\nboop\nnull\n0\n1\n\'\'\n\'abc\'\n\'0\'\n\'1\'"',
		'|',
		EXEC_PATH,
