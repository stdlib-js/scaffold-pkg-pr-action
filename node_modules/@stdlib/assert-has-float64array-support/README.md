...
-   <span class="package-name">[`@stdlib/assert-has-float64array-support-cli`][@stdlib/assert-has-float64array-support-cli]</span><span class="delimiter">: </span><span class="description">CLI package for use as a command-line utility.</span>
...
[@stdlib/assert-has-float64array-support-cli]: https://www.npmjs.com/package/@stdlib/assert-has-float64array-support-cli
...
[test-image]: https://github.com/stdlib-js/assert-has-float64array-support/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/assert-has-float64array-support/actions/workflows/test.yml?query=branch:v0.2.0
